 ...
 * @author dorian
 */
public class CircularLinkedIterator<T>  implements Iterator<T> {
    /**
     ...
     */
    public CircularLinkedIterator(LinearNode<T> list) {
        //if list is not null
        if(list!=null){
            //get the first node of the list
            LinearNode<T> first=list.getNext();
            //create a new node, copy of the first node of the list
            LinearNode<T> node=new LinearNode<>(first.getElement());
